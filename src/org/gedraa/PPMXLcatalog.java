...
public class PPMXLcatalog {
	...
	private static final String suffix = "&spatial=Cone&radius=1&catalog=ppmxl";

	public PPMXLcatalog(String id) {
		//setSYSPRoxy();
		String query ="";		
		...
		try {
			...
			while ((sCurrentLine = reader.readLine()) != null) {
				...
				if (sCurrentLine.startsWith("  ")) {
					;
					pmRA = Double.valueOf(sCurrentLine.substring(143, 152));
					pmRA= pmRA*3600;
					System.out.println(pmRA);
					pmDEC = Double.valueOf(sCurrentLine.substring(162, 172));
					pmDEC=pmDEC*3600;
	...
	public static void main(String[] args) {
		// setSYSPRoxy();
		PPMXLcatalog t = new PPMXLcatalog("21245216-5731334");
	}
